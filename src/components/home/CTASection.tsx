      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
          ...
          <div className="space-y-2">
            ...
            <Link to="/resume" className="group flex items-center justify-between py-4 border-b border-border">
            ...
            <Link to="/contact" className="mt-6 inline-flex items-center gap-2 bg-primary text-primary-foreground px-6 py-3.5 text-sm font-medium hover:bg-primary-hover transition-colors">
