  ...
  return (
    <article className="pt-32 md:pt-40 pb-24">
      <Seo
        ...
        type="article"
        keywords={post.tags}
        jsonLd={[postSchema, breadcrumbSchema]}
      />

      <header className="px-6 md:px-10 max-w-3xl mx-auto">
        <div className="flex flex-wrap items-center gap-x-6 gap-y-2 mb-8">
          <BackButton />
          <Link to="/writing" className="label-caps text-foreground-muted hover:text-primary transition-colors">
            All essays
          </Link>
        </div>
        ...
        <div className="mt-8 border-l-4 border-primary bg-primary/[0.03] p-6 rounded-r-lg">
          ...
          <div className="max-w-6xl mx-auto px-6 md:px-10 pt-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              {related.slice(0, 2).map((p) => (
                <Link key={p.slug} to={`/writing/${p.slug}`} className="group block">
            ...
            <div className="mt-12">
              <Link to="/writing" className="label-caps text-primary border-b border-primary pb-1">
                ← All essays
              </Link>
            </div>
          </div>
