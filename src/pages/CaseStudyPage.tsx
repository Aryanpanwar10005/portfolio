  ...
  return (
    <>
      <Seo
        ...
        image={study.cover}
        type="article"
        keywords={[study.title, 'Case Study', study.platform, 'Product Management']}
        jsonLd={[
          {
          ...
          },
          {
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: study.title, item: path },
            ],
          },
        ]}
      />
      <header className="pt-32 md:pt-40 pb-12 px-6 md:px-10 max-w-7xl mx-auto">
        <div className="flex flex-wrap items-center gap-x-6 gap-y-2 mb-8">
          <BackButton />
          <Link to="/case-studies" className="label-caps text-foreground-muted hover:text-primary transition-colors">
            All case studies
          </Link>
        </div>
        <motion.h1
