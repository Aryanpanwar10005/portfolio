  ...
  return (
    <>
      <Seo
        ...
        description="Ten PM-evidence essays. Each answers one hiring question with a real product decision — from discovery to trust to prioritization."
        path="/writing"
      ...
      {featured && (
        <section className="px-6 md:px-10 pb-16 max-w-6xl mx-auto">
          ...
          >
            <Link to={`/writing/${featured.slug}`} className="lg:col-span-7 block group">
            ...
            <div className="lg:col-span-5">
              ...
              <h2 className="mt-4 font-display text-4xl md:text-5xl text-foreground leading-tight">
                <Link to={`/writing/${featured.slug}`} className="hover:text-primary transition-colors">
                  {featured.title}
                </Link>
              </h2>
