...
export default function JourneyPage() {
  ...
  return (
    <>
      <Seo
        title="Journey — Aryan Panwar"
        description="The career timeline of Aryan Panwar — from ECE student and hardware builder to AI product development and aspiring PM."
        path="/journey"
        jsonLd={{
      ...
      <section className="px-6 md:px-10 pb-24 max-w-4xl mx-auto">
        <div ref={setTimelineRefs} className="relative pl-8 md:pl-14 border-l border-border">
          {journey.map((m, i) => (
            ...
            >
              <span className="absolute -left-[calc(2rem+0.4rem)] md:-left-[calc(3.5rem+0.4rem)] top-2 w-3 h-3 rounded-full bg-primary" />
