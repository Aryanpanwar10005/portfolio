...
export default function CaseStudiesIndex() {
  const featured = flagshipCaseStudies[0]
  return (
    <>
      <Seo
        title="Case Studies — Aryan Panwar"
        description="PM case studies by Aryan Panwar — flagship products (FitWardrobe, Mithivoices, SEO-GEO Optimizer), supporting projects, and a full archive of things I've built."
        path="/case-studies"
        image={featured?.cover}
        keywords={["Product Management", "Case Studies", "AI PM", "FitWardrobe", "Mithivoices", "SEO-GEO"]}
        jsonLd={{
      ...
      <section className="px-6 md:px-10 pb-16 max-w-7xl mx-auto">
        ...
        <div className="space-y-20">
          {flagshipCaseStudies.map((c, i) => (
            ...
            >
              <Link to={`/case-studies/${c.slug}`} className="lg:col-span-7 block group">
              ...
              <div className="lg:col-span-5">
                ...
                <Link to={`/case-studies/${c.slug}`} className="mt-6 inline-flex items-center gap-2 text-primary border-b border-primary pb-1 font-medium">
                  Read case study →
                </Link>
              </div>
            </motion.article>
