...
export default function ResumeFaqPage() {
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "FAQ", item: "/faq" },
    ],
  };
  ...
  return (
    <>
      <Seo
        title="Resume FAQ — Aryan Panwar"
        description="Quick answers for recruiters: which resume to download, what roles I'm targeting, how the case studies are built, and the best way to get in touch."
        path="/faq"
        keywords={[
          "aryan panwar faq",
          "resume faq",
          "product manager resume",
          "APM resume questions",
          "aryan panwar contact",
        ]}
