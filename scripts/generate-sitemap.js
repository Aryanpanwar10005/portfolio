...
const pages = [
  ...
  { rel: 'faq.html', url: '/faq.html', priority: '0.8', changefreq: 'monthly' },
  { rel: 'services.html', url: '/services.html', priority: '0.8', changefreq: 'monthly' },
  { rel: 'docs/Aryan.pdf', url: '/docs/Aryan.pdf', priority: '0.5', changefreq: 'monthly' },
